package graph;
/******************************************************************************
 *  Compilation:  javac graph.GraphGenerator.java
 *  Execution:    java graph.GraphGenerator V E
...
/**
 *  The {@code graph.GraphGenerator} class provides static methods for creating
...
public class GraphGenerator {
    ...
    public static Graph tree(int V) {
        ...
        G.addEdge(pq.remove(), pq.remove());
        return G;
    }

    /**
     * Unit tests the {@code graph.GraphGenerator} library.
     *
